...
# Identificadores de configuración/variable para la ingesta.
# Usa env vars si quieres alinear con los code_id creados desde el frontend.
CONFIG_NOMBRE = os.getenv("NIEVE_CONFIG_CODE_ID", "Nieve test forecast")
EXOGENA_NOMBRE = os.getenv("NIEVE_EXOGENA_NOMBRE", "nieve_caida_dia")
...
def ensure_configuracion(conn: pyodbc.Connection, nombre: str) -> int:
    """
    Busca/crea una configuración usando code_id dinámico (CONFIG_NOMBRE o env).
    Si no existe, la inserta y devuelve su id INT.
    """
